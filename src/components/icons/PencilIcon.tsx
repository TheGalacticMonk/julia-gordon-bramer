...
// From assets/pencil.svg. `fill` swapped for `currentColor` so it inherits whatever color
// context it's placed in (e.g. the active nav link's color) instead of a hardcoded gray.
